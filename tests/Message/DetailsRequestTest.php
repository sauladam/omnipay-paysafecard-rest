...
class DetailsRequestTest extends \Omnipay\Tests\TestCase
{
    ...
    public function it_returns_the_correct_test_endpoint_url()
    {
        ...
        $this->assertEquals(
            'https://apitest.paysafecard.com/v1/payments/some-payment-id',
    ...
    public function it_returns_the_correct_live_endpoint_url()
    {
        ...
        $this->assertEquals(
            'https://api.paysafecard.com/v1/payments/some-payment-id',
            $this->request->getEndpoint()
        );
    }
    ...
    {
        $this->setMockHttpResponse('DetailsSuccess.txt');
